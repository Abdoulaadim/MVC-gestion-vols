                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="aeroport_depart" id="aeroport_depart" value="<?php echo $vols->aeroport_depart; ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="aeroport_arrivee" class="text-info">aeroport_arrivee:</label><br>
                                <input type="text" name="aeroport_arrivee" id="aeroport_arrivee" value="<?php echo $vols->aeroport_arrivee; ?>" class="form-control">
                            </div>
                            <div class="form-group">
