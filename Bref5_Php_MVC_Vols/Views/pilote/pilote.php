...
if (isset($_POST['find'])) {
    $data = new PiloteControllers();
    $pilote = $data->findPilote();
} else {

    $data = new PiloteControllers();
    $pilote = $data->getALLPilote();
}
               ...
               <?php include('./views/includes/alert.php'); ?> 
                    <div class="card">
                        <div class=" car-body  bg-light p-4">
                            <a href="<?php echo BASE_URL; ?>pilote/add"> <button class="btn btn-sm btn-info "> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php foreach ($pilote as $pilote) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo ($pilote['nom']); ?></td>
                                        <td><?php echo ($pilote['prenom']); ?></th>
                                        <td><?php echo ($pilote['num_pilote']); ?></td>
