               ...
               <?php include('./views/includes/alert.php'); ?> 
                    <div class="card">
                        <div class=" car-body  bg-light p-4">
                            <a href="<?php echo BASE_URL; ?>client/add"> <button class="btn btn-sm btn-info "> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php foreach ($client as $client) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo ($client['prenom']); ?></th>
                                        <td><?php echo ($client['cin']); ?></td>
                                        <td><?php echo ($client['telephone']); ?></td>
                                        <td><?php echo ($client['email']); ?></th>
