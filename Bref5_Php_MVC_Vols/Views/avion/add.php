                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="" method="post">
                            <h3 class="text-center text-info">Ajouter Avion</h3>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="typee" id="typee" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="capacite" class="text-info">Capacité:</label><br>
