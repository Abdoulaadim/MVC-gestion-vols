                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="" method="post">
                            <h3 class="text-center text-info">Ajouter Reservation</h3>
                            <div class="form-group" style="display:none">
                                <label for="id_client" class="text-info">id_client:</label><br>
                                <input type="text" name="id_client" id="id_client" value="<?php  echo $_SESSION['id_client'];?>" class="form-control">
                            </div>

                            <div class="form-group">
                                <label for="nom" class="text-info">nom_prenom:</label><br>
                                <input type="text" name="nom" id="nom" value="<?php  echo $_SESSION['nom']." ". $_SESSION['prenom'];?>" class="form-control">
                            </div>

                            <div class="form-group" style="display:none">
                                <label for="id_vols" class="text-info">id_vols:</label><br>
                                <input type="text" name="id_vols" id="id_vols" value="<?php echo $vols->id_vols; ?>" class="form-control">
                            </div>


                            <div class="form-group py-3 ">
                                <label for="nbr_passager" class="text-info">nbr_passager:</label><br>
